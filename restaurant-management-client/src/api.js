...
export const getAllRestaurants = () =>
  api.get("/restaurants/all").then((res) => res.data);

export const getRestaurantProfile = (restaurantId) =>
  api.get(`/restaurants/${restaurantId}`).then((res) => res.data);
...
export const getRestaurantDashboard = (restaurantId) =>
  api
    .get(`/restaurants/dashboard?restaurantId=${restaurantId}`)
    .then((res) => res.data);
...
export const getAdminMenuItems = (restaurantId) =>
  api.get(`/menu/restaurant/${restaurantId}/all`).then((res) => res.data);
...
export const updateCartItem = (id, payload) =>
...
export const getRestaurantOrders = (restaurantId) =>
  api.get(`/orders/restaurant/${restaurantId}`).then((res) => res.data);
